    ...
    <aside class="sidebar" id="sidebar" aria-label="Sidebar navigation">
        ...
        <div class="nav-section"><div class="section-label">Manage</div>
            <div class="nav-list">
                ...
                <div class="nav-group open" id="sipChannelsGroup">
                    <a href="{{ route('sip-channels') }}" class="nav-item nav-parent-row {{ request()->routeIs('sip-channels') ? 'active' : '' }}" id="sipChannelsToggle" aria-expanded="true" aria-controls="sipChannelsSub">
                ...
                <div class="nav-group open" id="networkGroup">
                    <button type="button" class="nav-item nav-parent-row" id="networkToggle" aria-expanded="true" aria-controls="networkSub">
