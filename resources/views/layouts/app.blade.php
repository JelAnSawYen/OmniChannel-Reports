    ...
    <aside class="sidebar" id="sidebar" aria-label="Sidebar navigation">
        ...
        <div class="nav-section"><div class="section-label">Manage</div>
            <div class="nav-list">
                ...
                @if(auth()->user()->canAccessModule('sip-channels'))<a href="{{ route('sip-channels') }}" class="nav-item {{ request()->routeIs('sip-channels') ? 'active' : '' }}"><span class="nav-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M14.5 3a6.5 6.5 0 0 1 5.5 5.5"/><path d="M14.5 6.8a3 3 0 0 1 2.4 2.4"/><path d="M20 16.9v2.3a1.7 1.7 0 0 1-1.9 1.7 16.8 16.8 0 0 1-7.3-2.6 16.5 16.5 0 0 1-5.1-5.1A16.8 16.8 0 0 1 3.1 5.9 1.7 1.7 0 0 1 4.8 4h2.3a1.7 1.7 0 0 1 1.7 1.5c.1.8.3 1.6.6 2.3a1.7 1.7 0 0 1-.4 1.8l-1 1a13.5 13.5 0 0 0 5.1 5.1l1-1a1.7 1.7 0 0 1 1.8-.4c.7.3 1.5.5 2.3.6A1.7 1.7 0 0 1 20 16.9z"/></svg></span><span>SIP Channels</span></a>@endif
