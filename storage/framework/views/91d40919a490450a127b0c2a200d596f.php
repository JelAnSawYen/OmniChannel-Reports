...
<tr>
    <?php $__currentLoopData = $gatewayColumns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field=>$label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <th><button type="button" class="sortable-button" data-sort="<?php echo e($field); ?>"><span><?php echo e($label); ?></span></button></th>
...
<tr><td colspan="10"><div class="empty-state"><?php echo e($resource['empty']); ?></div></td></tr>
<?php endif; ?>
</tbody>
</table>
        ...
        <form id="mediaGatewayForm" method="POST" action="<?php echo e(route($resource['store'])); ?>">
            ...
            <div class="modal-body">
                ...
                <div class="form-grid">
                    ...
                    <?php if(($resource['index'] ?? '') === 'gsm-gateways.index'): ?>
...
<div class="modal-backdrop" id="deleteModal">
    <div class="modal small">
        <div class="modal-header"><h3>Delete <?php echo e($resource['entity']); ?></h3><button type="button" class="close-btn" data-close="deleteModal">×</button></div>
        <div class="modal-body"><p>Are you sure you want to delete this <?php echo e($resource['entity']); ?>?</p></div>
