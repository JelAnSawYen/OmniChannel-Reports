...
<div class="pin-campaign-combo" data-campaign-combo>
    <input class="form-control" name="<?php echo e($inputName); ?>" id="<?php echo e($inputId); ?>" placeholder="<?php echo e($placeholder); ?>" autocomplete="off" <?php if($required): ?> required <?php endif; ?> aria-autocomplete="list" aria-controls="<?php echo e($menuId); ?>">
    <div class="pin-campaign-menu" id="<?php echo e($menuId); ?>" hidden role="listbox">
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <div class="pin-campaign-empty"><?php echo e($emptyText); ?></div>
        <?php endif; ?>
    </div>
</div>
