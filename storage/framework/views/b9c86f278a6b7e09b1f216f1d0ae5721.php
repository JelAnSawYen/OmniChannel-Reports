...
<div class="transfer">
    ...
    <div class="transfer-menu" id="transferMenu" role="menu">
        ...
        <?php endif; ?>
        <a role="menuitem" id="exportDataButton" href="<?php echo e($exportUrl); ?>">
...
<div class="modal-backdrop" id="importModal">
    <div class="modal">
        ...
        <div class="modal-body">
            <p class="import-lead">Upload the official Excel template to import <?php echo e($entityTitle); ?> in bulk. Each row is one record.</p>
            <div class="import-section">
                <h4>1. Download Template</h4>
                <a class="btn primary" href="<?php echo e($templateUrl); ?>">
                    <svg class="btn-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 4v12"></path><path d="m7 11 5 5 5-5"></path><path d="M5 20h14"></path></svg>
            ...
            <div class="table-wrap import-preview-wrap">
                <table class="import-preview-table" aria-label="Import preview">
                    <thead>
                        <tr>
                            <th>Row #</th>
                            <?php $__currentLoopData = $previewHeaders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $header): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\OmniChannel\OmniChannel_Inventory_Production_Updated\resources\views/partials/data-transfer.blade.php ENDPATH**/ ?>