    ...
    <div class="modal small" role="dialog" aria-modal="true" aria-labelledby="simInventoryModalTitle">
        ...
        <div class="modal-body">
            ...
            <div class="sim-pick-list">
                <a class="sim-pick sim-pick-globe" href="<?php echo e(route('globe-sim')); ?>">
                    <span class="sim-pick-icon" aria-hidden="true">
                        <span class="nav-icon"><img class="nav-icon-img" src="<?php echo e(asset('icons/globe-sim.png')); ?>" alt=""></span>
                    </span>
                    <span class="sim-pick-copy">
                        <strong>Globe SIM</strong>
                        <small>Total Records</small>
                    </span>
                    <span class="sim-pick-count"><?php echo e($globeSims); ?></span>
                </a>
                <a class="sim-pick sim-pick-smart" href="<?php echo e(route('smart-sim')); ?>">
                    <span class="sim-pick-icon" aria-hidden="true">
                        <span class="nav-icon"><img class="nav-icon-img" src="<?php echo e(asset('icons/smart-sim.png')); ?>" alt=""></span>
                    </span>
                    <span class="sim-pick-copy">
                        <strong>Smart SIM</strong>
                        <small>Total Records</small>
                    </span>
                    <span class="sim-pick-count"><?php echo e($smartSims); ?></span>
                </a>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\OmniChannel\OmniChannel_Inventory_Production_Updated\resources\views/dashboard/index.blade.php ENDPATH**/ ?>