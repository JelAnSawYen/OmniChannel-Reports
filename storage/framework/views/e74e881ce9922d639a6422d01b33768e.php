...
(function () {
    ...
    const canConfigure = <?php echo json_encode($canConfigure ?? false, 15, 512) ?>;
    const statusUrlTemplate = <?php echo json_encode($statusUpdateUrlTemplate ?? '', 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\OmniChannel\OmniChannel_Inventory_Production_Updated\resources\views/program-location/index.blade.php ENDPATH**/ ?>