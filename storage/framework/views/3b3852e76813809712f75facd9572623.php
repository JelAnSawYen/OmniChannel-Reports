...
?>
<tr <?php if(auth()->user()->hasPermission('media.delete')): ?> data-bulk-row="main" data-bulk-id="<?php echo e($record->id); ?>" data-bulk-url="<?php echo e(route('campaigns.bulk-destroy')); ?>" <?php endif; ?>>
