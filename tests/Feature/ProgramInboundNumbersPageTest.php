...
class ProgramInboundNumbersPageTest extends TestCase
{
    ...
    public function test_table_uses_inbound_columns_alignment_and_stacked_numbers(): void
    {
        ...
        $this->assertMatchesRegularExpression('/th\.pin-campaign-col[\s\S]*?text-align:\s*center/', $css);
        $this->assertDoesNotMatchRegularExpression('/th\.pin-campaign-col[\s\S]*?padding-left:\s*20px/', $css);
