...
class LocationController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('program-location.index', [
            'sites' => $sites,
            'search' => $search,
    ...
    public function show(string $location): View
    {
        ...
        return view('program-location.show', [
    ...
    public function bulkDestroy(Request $request, string $location)
    {
        $name = $this->locationName($location);
        $this->guardMutation('media.delete');

        foreach ($this->validatedBulkIds($request) as $id) {
            $record = MediaGateway::query()
        ...
        return back()->with('success', 'Selected GSM Gateways deleted successfully.');
    }
